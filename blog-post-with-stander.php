...
<html lang="es">
    ...
    <body>
                                ...
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="nav-item">
												<a href="blog-post-with-stander.php" class="nav-link active">Blog Post With Stander</a>
											</li>
                                            <li class="nav-item">
			...
			<div class="container">
				<div class="page-title-content">
					...
					<ul>
						...
						<li class="active">Blog Post With stander</li>
					</ul>
				</div>
			</div>
		...
		<!-- Sección Blog -->
		<section class="our-blog-area our-blog-post-standers-area ptb-100">
			<div class="container">
				<div class="row">
					<div class="col-lg-8">
						<div class="row">
							<div class="col-lg-12 col-md-6">
								<div class="single-blog">
									...
									<div class="blog-content">
										...
										<p>The most common treatment area for fat grafting in the face may inject into several areas area for fat grafting in the face may inject into several.</p>
										
										<div class="stnader-reda-more">
											<a href="blog-details.php" class="default-btn">
												Leer más
							...
							<div class="col-lg-12 col-md-6">
								<div class="single-blog">
									...
									<div class="blog-content">
										<ul>
											<li>
												<a href="#"><i class="ri-user-line"></i> Juhon</a>
											</li>
											<li>
												<i class="ri-calendar-line"></i> 05 January, 2021
											</li>
							...
							<div class="col-lg-12 col-md-6 offset-md-3 offset-lg-0">
								<div class="single-blog">
									...
									<div class="blog-content">
										<ul>
											<li>
												<a href="#"><i class="ri-user-line"></i> Alex</a>
											</li>
											<li>
												<i class="ri-calendar-line"></i> 05 January, 2021
											</li>
