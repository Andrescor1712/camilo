                        ...
                        <nav class="navbar navbar-expand-md navbar-light">
                            ...
                            <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                                        ...
                                        <ul class="dropdown-menu">
											...
											<li class="nav-item">
												...
												<ul class="dropdown-menu">
													...
													<li class="nav-item">
														<a href="Agenda tu Citaita.php" class="nav-link">Agenda tu Cita</a>
													</li>
                                ...
                                <div class="others-options">
									<ul>
										<li>
											<a href="Agenda tu Citaita.php" class="default-btn">
												Agenda tu Cita
				...
				<div class="row">
					...
					<div class="col-lg-3 col-sm-6">
						<div class="single-team bg-dceff8">
							...
							<h3><a href="dectors-details.php">Malka Benton</a></h3>
							<span class="profession">Plastic Surgery</span>
					...
					<div class="col-lg-3 col-sm-6">
						<div class="single-team bg-feebea">
							...
							<h3><a href="doctors-details.php">Janely Kelley</a></h3>
							<span class="profession">Reconstructive Surgery</span>
					...
					<div class="col-lg-3 col-sm-6">
						<div class="single-team bg-dceff8">
							...
							<h3><a href="doctors-details.php">Amilia Luna</a></h3>
							<span class="profession">Facial Surgery</span>
					...
					<div class="col-lg-3 col-sm-6">
						<div class="single-team bg-feebea">
							...
							<h3><a href="doctors-details.php">Olivia Jacobs</a></h3>
							<span class="profession">Non-Surgical</span>
