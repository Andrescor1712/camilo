							...
							<ul class="accordion">
								<li class="accordion-item">
									...
									<div class="accordion-content show">
										<p>Cosmetic surgery is a unique discipline of medicine focused on enhancing appearance through surgical and medical techniques. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
								...
								<li class="accordion-item">
									<a class="accordion-title" href="javascript:void(0)">
										<i class="ri-add-fill"></i>
										Best Way to Eyelid Lift Surgery									
									</a>
								...
								<li class="accordion-item">
									<a class="accordion-title" href="javascript:void(0)">
										<i class="ri-add-fill"></i>
										10 Usefully Technique For Face And Neck Rejuvenation
									</a>
								...
								<li class="accordion-item">
									<a class="accordion-title" href="javascript:void(0)">
										<i class="ri-add-fill"></i>
										Why You Need to Breast Implant Surgery?								
									</a>
						...
						<div class="questions">
							...
							<form>
								<div class="row">
									...
									<div class="col-lg-6">
										<div class="form-group">
											<textarea name="message" class="form-control" rows="5" placeholder="Type Your Questions"></textarea>
										</div>
									</div>
								</div>
