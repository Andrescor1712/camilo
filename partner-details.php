                                ...
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="dropdown-menu">
											...
											<li class="nav-item">
												<a href="partner-details.php" class="nav-link active">Partner Details</a>
											</li>
											<li class="nav-item">
		...
		<section class="partner-details-area ptb-100">
			<div class="container">
				...
				<div class="partner-details">
					<div class="partner-single-img">
						<img src="assets/images/partner-details/partner-details-1.jpg" alt="Image">
					</div>
