                                        ...
                                        <ul class="dropdown-menu">
											...
											<li class="nav-item">
												...
												<ul class="dropdown-menu">
													...
													<li class="nav-item">
														<a href="product-details.php" class="nav-link active">Product Details</a>
													</li>
												</ul>
											</li>
                                            <li class="nav-item">
				...
				<div class="row align-items-center">
					<div class="col-lg-6 col-md-12">
						<div class="product-details-image">
							<img src="assets/images/product-details/product-details1.png" alt="Image">
						</div>
					</div>

					<div class="col-lg-6 col-md-12">
						<div class="product-details-desc">
							<h3>Corona Safety Mask</h3>
