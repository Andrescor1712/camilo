    ...
    <body>
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6">
						<div class="single-services">
							...
							<h3>Neck Lift</h3>
							<p>A neck lift is a cosmetic plastic surgery basically a procedure that removes excess skin and fat from the neck to address.</p>
					...
					<div class="col-12">
						<div class="check-procedures">
							<a href="tratamientos.php" class="read-more">
								Check Tratamientos 
							</a>
						</div>
					</div>
		...
		<section class="gallery-area gallery-popup pb-100">
			<div class="container-fluid p-0">
				<div class="section-title">
					<h2>Explore Our Patient Gallery</h2>
					<p>The most common treatment area for fat grafting in the face. Fat may be injected into several areas to restore youthful volume and </p>
					<p></p>
				</div>
				...
				<div class="gallery-slider owl-carousel owl-theme">
					<div class="gallery-item">
						...
						<div class="gallery-item-content">
							<div class="gallery-link">
								<a href="assets/images/gallery/gallery-1.jpg" class="img">
					...
					<div class="gallery-item">
						...
						<div class="gallery-item-content">
							<div class="gallery-link">
								<a href="assets/images/gallery/gallery-2.jpg" class="img">
									<i class="ri-add-fill"></i>
								</a>
								<a href="gallery.php">
									<i class="ri-links-fill"></i>
								</a>
								<p>Face Screen Surgery</p>
							</div>
						</div>
					</div>
					...
					<div class="gallery-item">
						...
						<div class="gallery-item-content">
							<div class="gallery-link">
								<a href="assets/images/gallery/gallery-3.jpg" class="img">
									<i class="ri-add-fill"></i>
								</a>
								<a href="gallery.php">
									<i class="ri-links-fill"></i>
								</a>
								<p>Face Before After</p>
							</div>
						</div>
					</div>
					...
					<div class="gallery-item">
						...
						<div class="gallery-item-content">
							<div class="gallery-link">
								<a href="assets/images/gallery/gallery-4.jpg" class="img">
									<i class="ri-add-fill"></i>
								</a>
								<a href="gallery.php">
									<i class="ri-links-fill"></i>
					...
					<div class="gallery-item">
						...
						<div class="gallery-item-content">
							<div class="gallery-link">
								<a href="assets/images/gallery/gallery-5.jpg" class="img">
									<i class="ri-add-fill"></i>
								</a>
								<a href="gallery.php">
									<i class="ri-links-fill"></i>
			...
			<div class="container">
				...
				<div class="reviews-patients-slider owl-carousel owl-theme">
					<div class="single-reviews-patients">
						...
						<p>‘‘faceat really the best ever in United State mostly breast implant service Face-lift is a cosmetic surgical procedure to create a younger appearance in your face. The procedure can reduce the sagging. really the best ever in United State mostly breast implant service Face-lift is a cosmetic surgica’’</p>
					</div>
